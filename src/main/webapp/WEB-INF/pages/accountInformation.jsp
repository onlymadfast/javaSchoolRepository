    ...
    <div class="card">
        <div class="card-body">
            ...
            <p>In this store you can shop for various reasons, one of the possible reasons is... you are missing
                something</p>
            <a href="#" class="stretched-link">Go to product list</a>
        </div>
    </div>
    <br>
    <div class="card">
        <div class="card-body">
            ...
            <a href="1" class="stretched-link">View order status information</a>
        </div>
    </div>
    <br>
    <div class="card">
        <div class="card-body">
            ...
            <a href="${pageContext.request.contextPath}/viewAccInfo" class="stretched-link">View/Edit your account information</a>
        </div>
    </div>
</div>
